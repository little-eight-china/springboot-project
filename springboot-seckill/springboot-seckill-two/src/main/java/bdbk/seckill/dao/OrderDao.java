...
public interface OrderDao {
	...
	@Insert("insert into order_info(user_id, goods_id, name, img, goods_count, price, order_channel, status, create_date)values("
			+ "#{userId}, #{goodsId}, #{name}, #{img}, #{goodsCount}, #{price}, #{orderChannel},#{status},#{createDate} )")
