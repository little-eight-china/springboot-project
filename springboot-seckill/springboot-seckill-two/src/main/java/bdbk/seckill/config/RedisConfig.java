...
public class RedisConfig {
    @Bean
    public RedisTemplate<String, SeckillUser> redisTemplate(RedisConnectionFactory factory) {
        RedisTemplate<String, SeckillUser> template = new RedisTemplate<>();
        template.setConnectionFactory(factory);
        Jackson2JsonRedisSerializer<SeckillUser> jackson2JsonRedisSerializer = new Jackson2JsonRedisSerializer<>(SeckillUser.class);
